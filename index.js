...
export default class KeyboardDoneButton extends Component {
    ...
    render() {
        ...
        const keyboardTopOffset = this.state.hideKA ? this.state.visibleHeight - 1 : this.state.visibleHeight - INPUT_ACCESSORY_HEIGHT - 10;

        return (
            <View style={[defaultStyle.Container, {opacity: this.state.opacity, top: keyboardTopOffset}, style]}
